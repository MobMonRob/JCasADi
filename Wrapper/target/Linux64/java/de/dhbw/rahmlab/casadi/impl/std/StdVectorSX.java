...
public class StdVectorSX extends java.util.AbstractList<de.dhbw.rahmlab.casadi.impl.casadi.SX> implements java.util.RandomAccess {
  ...
  */
  ...
  private int doCapacity() {
    return de.dhbw.rahmlab.casadi.impl.core__JNI.std_StdVectorSX_doCapacity(swigCPtr, this);
  }

  private void doReserve(int n) {
    de.dhbw.rahmlab.casadi.impl.core__JNI.std_StdVectorSX_doReserve(swigCPtr, this, n);
  }
