...
public class StdVectorCasadiGenericType extends java.util.AbstractList<de.dhbw.rahmlab.casadi.impl.casadi.GenericType> implements java.util.RandomAccess {
  ...
  */
  ...
  private int doCapacity() {
    return de.dhbw.rahmlab.casadi.impl.core__JNI.std_StdVectorCasadiGenericType_doCapacity(swigCPtr, this);
  }

  private void doReserve(int n) {
    de.dhbw.rahmlab.casadi.impl.core__JNI.std_StdVectorCasadiGenericType_doReserve(swigCPtr, this, n);
  }
