...
public class CasADiBasicsExercise {
    ...
    public static MX f(MX x, MX y) {
        MX w = MX.plus(x, y);
        MX z = MX.times(w, y);
        z = MX.times(new MX(4), z);
        return z;
    }

    public static void withoutCasADiFunctions() {
        var r = f(new MX(1), MX.sin(x));
    ...
    public static void withCasADiFunctions() {
        ...
        f.call(new StdVectorMX(new MX[]{new MX(1), MX.sin(x)}), result);
        System.out.println(result);
        System.out.println("------------------------------------------------");
        // -------------------------When does CasADi Function conserve memory--------------------------------------
//        for (int i = 1; i <= 10; i++) {
//            f.call(new StdVectorMX(new MX[]{new MX(1), MX.sin(MX.times(x, new MX(i)))}), result);
//            System.out.println(result);
//        }
        ...
        var r2 = new MX(0);
        for (int i = 1; i <= 10; i++) {
            r2 = MX.plus(r2, f(new MX(1), MX.sin(MX.times(new MX(i), x))));
    ...
    public static void exerciseSheet() {
        ...
        Function g = new Function("g", new StdVectorMX(new MX[]{x}), new StdVectorMX(new MX[]{MX.sqrt(x), MX.times(x, x)}));
        Function h = new Function("h", new StdVectorMX(new MX[]{x, y}), new StdVectorMX(new MX[]{MX.times(MX.sin(x), y)})); // Does not work as in the video
        // Cannot find a way to implement lambda-Function F in Java
        // -------
        System.out.println(MX.plus(new MX(5), x).getClass().getName()); // 2
        System.out.println(MX.minus(x, x).getClass().getName()); // 3
        System.out.println(MX.eq(x, x).getClass().getName()); // 4
        System.out.println(MX.eq(x, y).getClass().getName()); // 5
        System.out.println(MX.times(A, x).getClass().getName()); // 6
        System.out.println(MX.times(A, new MX(0)).getClass().getName()); // 7
        System.out.println(MX.gradient(MX.sin(x), x).getClass().getName()); // 8
        System.out.println(MX.gradient(MX.sin(x), x).getClass().getName()); // 9
        ...
        Function square = new Function("square", new StdVectorMX(new MX[]{x, y}), new StdVectorMX(new MX[]{MX.times(MX.times(MX.sin(x), y), MX.times(MX.sin(x), y))})); // Goal 7
        ...
        Function m2 = new Function("m2", new StdVectorMX(new MX[]{x}), new StdVectorMX(new MX[]{new MX(MX.sin(x))})); // Goal 10
        ...
        Function f2 = new Function("f2", new StdVectorSX(new SX[]{a, b}), new StdVectorSX(new SX[]{new SX(SX.plus(SX.sin(a), b))}), new StdVectorStdString(new String[]{"x", "y"}), new StdVectorStdString(new String[]{"z"}));
        Function g2 = new Function("g2", new StdVectorSX(new SX[]{a}), new StdVectorSX(new SX[]{SX.sqrt(a), SX.pow(a, new SX(2))}), new StdVectorStdString(new String[]{"x"}), new StdVectorStdString(new String[]{"p0", "p1"}));
