...
public class Opti implements ISharedObject {
  ...
  public Opti(long cPtr, boolean cMemoryOwn) {
    ...
    swigCPtr = cPtr;
	if (cMemoryOwn) {
		this.cleanupPreventer = REGISTER_DELETION(this, this.swigCPtr, Opti::delete);
	}
  }
  ...
  */
   ...
   * <br>
   * problem_type of optimization 'nlp' or 'conic' (default nlp)<br>
   * <br>
   *       
   */
   ...
   * <br>
   * n number of rows (default 1)<br>
   * m number of columnss (default 1)<br>
   * attribute: 'full' (default) or 'symmetric'<br>
   * <br>
   *       
   */
  ...
  public void minimize(de.dhbw.rahmlab.casadi.impl.casadi.MX f) {
    de.dhbw.rahmlab.casadi.impl.core__JNI.casadi_Opti_minimize(swigCPtr, this, de.dhbw.rahmlab.casadi.impl.casadi.MX.getCPtr(f), f);
  }
  ...
  public void subject_to(de.dhbw.rahmlab.casadi.impl.casadi.MX g) {
    de.dhbw.rahmlab.casadi.impl.core__JNI.casadi_Opti_subject_to__SWIG_0(swigCPtr, this, de.dhbw.rahmlab.casadi.impl.casadi.MX.getCPtr(g), g);
  }

  public void subject_to(de.dhbw.rahmlab.casadi.impl.std.StdVectorMX g) {
    de.dhbw.rahmlab.casadi.impl.core__JNI.casadi_Opti_subject_to__SWIG_1(swigCPtr, this, de.dhbw.rahmlab.casadi.impl.std.StdVectorMX.getCPtr(g), g);
  }
  ...
  public void subject_to() {
    de.dhbw.rahmlab.casadi.impl.core__JNI.casadi_Opti_subject_to__SWIG_2(swigCPtr, this);
  }

  /**
   *  Set a solver<br>
   * <br>
   * solver any of the nlpsol plugins can be used here<br>
   *            In practice, not all nlpsol plugins may be supported yet<br>
   * options passed on to nlpsol plugin<br>
   *            No stability can be guaranteed about this part of the API<br>
   * options to be passed to nlpsol solver<br>
   *            No stability can be guaranteed about this part of the API<br>
   * <br>
   *       
   */
   ...
   * <br>
   * name Name of the resulting CasADi Function<br>
   * args List of parameters and decision/dual variables<br>
   *                (which can be given an initial guess) with the resulting Function<br>
   * res List of expressions that will get evaluated at the optimal solution<br>
   * opts Standard CasADi Funcion options<br>
   * <br>
   *       
   */
  ...
  public String class_name() {
    return de.dhbw.rahmlab.casadi.impl.core__JNI.casadi_Opti_class_name(swigCPtr, this);
  }
  ...
  public void print_ptr(SWIGTYPE_p_std__ostream stream) {
    de.dhbw.rahmlab.casadi.impl.core__JNI.casadi_Opti_print_ptr__SWIG_0(swigCPtr, this, SWIGTYPE_p_std__ostream.getCPtr(stream));
  }
  ...
  public void print_ptr() {
    de.dhbw.rahmlab.casadi.impl.core__JNI.casadi_Opti_print_ptr__SWIG_1(swigCPtr, this);
  }
  ...
  public boolean is_null() {
    return de.dhbw.rahmlab.casadi.impl.core__JNI.casadi_Opti_is_null(swigCPtr, this);
  }
  ...
  public long __hash__() {
    return de.dhbw.rahmlab.casadi.impl.core__JNI.casadi_Opti___hash__(swigCPtr, this);
  }
