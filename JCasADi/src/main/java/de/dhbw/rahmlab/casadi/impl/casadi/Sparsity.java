...
public class Sparsity implements ISparsitySparsityInterface, ISharedObject {
  ...
  */
  ...
  public de.dhbw.rahmlab.casadi.impl.std.StdVectorCasadiInt compress() {
    return new de.dhbw.rahmlab.casadi.impl.std.StdVectorCasadiInt(de.dhbw.rahmlab.casadi.impl.core__JNI.casadi_Sparsity_compress(swigCPtr, this), true);
  }
   ...
   * <br>
   *  mapping the non-zeros of the original matrix<br>
   *              for each non-zero of the new matrix<br>
   * <br>
   *         
   */
  ...
  /**
   *  Conditional comment: INTERNAL Accessed by SparsityInterface<br>
   * <br>
   *         
   */
   ...
   * <br>
   * allow_empty Allow the resultant vector to have structural zeros<br>
   * <br>
   ...
   * <br>
   * allow_empty Disregard empty rows and columns in the analysis<br>
   * <br>
   *         
   */
   ...
   * <br>
   * allow_empty Disregard empty rows in the analysis<br>
   * <br>
   *         
   */
   ...
   * <br>
   * allow_empty Disregard empty columns in the analysis<br>
   * <br>
   *         
   */
   ...
   * <br>
   * strictly if true, then do not allow multiple entries<br>
   * <br>
   *         
   */
  ...
  public static boolean test_cast(SWIGTYPE_p_casadi__SharedObjectInternal ptr) {
    return de.dhbw.rahmlab.casadi.impl.core__JNI.casadi_Sparsity_test_cast(SWIGTYPE_p_casadi__SharedObjectInternal.getCPtr(ptr));
  }
  ...
  public String class_name() {
    return de.dhbw.rahmlab.casadi.impl.core__JNI.casadi_Sparsity_class_name(swigCPtr, this);
  }
  ...
  public void disp(SWIGTYPE_p_std__ostream stream, boolean more) {
    de.dhbw.rahmlab.casadi.impl.core__JNI.casadi_Sparsity_disp__SWIG_0(swigCPtr, this, SWIGTYPE_p_std__ostream.getCPtr(stream), more);
  }
  ...
  public void disp(SWIGTYPE_p_std__ostream stream) {
    de.dhbw.rahmlab.casadi.impl.core__JNI.casadi_Sparsity_disp__SWIG_1(swigCPtr, this, SWIGTYPE_p_std__ostream.getCPtr(stream));
  }
  ...
  public void print_ptr(SWIGTYPE_p_std__ostream stream) {
    de.dhbw.rahmlab.casadi.impl.core__JNI.casadi_Sparsity_print_ptr__SWIG_0(swigCPtr, this, SWIGTYPE_p_std__ostream.getCPtr(stream));
  }
  ...
  public void print_ptr() {
    de.dhbw.rahmlab.casadi.impl.core__JNI.casadi_Sparsity_print_ptr__SWIG_1(swigCPtr, this);
  }
  ...
  public boolean is_null() {
    return de.dhbw.rahmlab.casadi.impl.core__JNI.casadi_Sparsity_is_null(swigCPtr, this);
  }
  ...
  public long __hash__() {
    return de.dhbw.rahmlab.casadi.impl.core__JNI.casadi_Sparsity___hash__(swigCPtr, this);
  }
