...
public static long longCall(LongCall cl) {
  ...
  /**
   *  Generate a hash value incrementally, array<br>
   * <br>
   *       
   */
  public static void hash_combine(SWIGTYPE_p_std__size_t seed, SWIGTYPE_p_long_long v, long sz) {
    core__JNI.hash_combine__SWIG_1(SWIGTYPE_p_std__size_t.getCPtr(seed), SWIGTYPE_p_long_long.getCPtr(v), sz);
  }

  /**
   *  Generate a hash value incrementally (function taken from boost)<br>
   * <br>
   *       
   */
  public static void hash_combine(SWIGTYPE_p_std__size_t seed, de.dhbw.rahmlab.casadi.impl.std.StdVectorCasadiInt v) {
    core__JNI.hash_combine__SWIG_2(SWIGTYPE_p_std__size_t.getCPtr(seed), de.dhbw.rahmlab.casadi.impl.std.StdVectorCasadiInt.getCPtr(v), v);
  }
  ...
  /**
   *  Get input scheme of simulators<br>
   * <br>
   *       
   */
  ...
  /**
   *  Get simulator output scheme of simulators<br>
   * <br>
   *       
   */
  ...
  /**
   *  Get simulator input scheme name by index<br>
   * <br>
   *       
   */
  ...
  /**
   *  Get the number of simulator inputs<br>
   * <br>
   *       
   */
  ...
  /**
   *  Get the number of simulator outputs<br>
   * <br>
   *       
   */
   ...
   *   C interpolating coefficients to obtain derivatives.<br>
   *       Length: order+1, order+1<br>
   * <br>
   *     {@literal 
   ...
   * <br>
   *   D interpolating coefficients to obtain end state.<br>
   *       Length: order+1<br>
   * <br>
   *     {@literal 
   ...
   * state_to_orig A mapping of integrator (semi explicit) states to states of the original DAE<br>
   * phi A function to compute the invariants of the reduced DAE<br>
   *             Inputs:<br>
   *               - x and z: (semi explicit) integrator states; typically integrator outputs xf and zf<br>
   *               - p: parameters<br>
   *               - t: time<br>
   ...
   * <br>
   * lam_forward (lam_g,p)-&gt;(lam_sg,lam_x)<br>
   * lam_backward (lam_sg,lam_x,p)-&gt;(lam_g)<br>
   * <br>
   *       
   */
