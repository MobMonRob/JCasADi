...
public class Function implements ISharedObject {
   ...
   * <br>
   * order Only 1 (linear) and 2 (nonlinear) allowed<br>
   * tr   Flip the relationship. Return which expressions contain the variables<br>
   * <br>
   *         
   */
  ...
  public static boolean test_cast(SWIGTYPE_p_casadi__SharedObjectInternal ptr) {
    return de.dhbw.rahmlab.casadi.impl.core__JNI.casadi_Function_test_cast(SWIGTYPE_p_casadi__SharedObjectInternal.getCPtr(ptr));
  }

  /**
   *  End of conditional comment.Get all statistics obtained at the end of the last evaluate call
   */
   ...
   * <br>
   * max_depth  Maximum depth - a negative number indicates no maximum<br>
   * <br>
   *         
   */
   ...
   * <br>
   * name  Name of function needed<br>
   * max_depth  Maximum depth - a negative number indicates no maximum<br>
   * <br>
   *         
   */
  ...
  public String class_name() {
    return de.dhbw.rahmlab.casadi.impl.core__JNI.casadi_Function_class_name(swigCPtr, this);
  }
  ...
  public void disp(SWIGTYPE_p_std__ostream stream, boolean more) {
    de.dhbw.rahmlab.casadi.impl.core__JNI.casadi_Function_disp__SWIG_0(swigCPtr, this, SWIGTYPE_p_std__ostream.getCPtr(stream), more);
  }
  ...
  public void disp(SWIGTYPE_p_std__ostream stream) {
    de.dhbw.rahmlab.casadi.impl.core__JNI.casadi_Function_disp__SWIG_1(swigCPtr, this, SWIGTYPE_p_std__ostream.getCPtr(stream));
  }
  ...
  public void print_ptr(SWIGTYPE_p_std__ostream stream) {
    de.dhbw.rahmlab.casadi.impl.core__JNI.casadi_Function_print_ptr__SWIG_0(swigCPtr, this, SWIGTYPE_p_std__ostream.getCPtr(stream));
  }
  ...
  public void print_ptr() {
    de.dhbw.rahmlab.casadi.impl.core__JNI.casadi_Function_print_ptr__SWIG_1(swigCPtr, this);
  }
  ...
  public boolean is_null() {
    return de.dhbw.rahmlab.casadi.impl.core__JNI.casadi_Function_is_null(swigCPtr, this);
  }
  ...
  public long __hash__() {
    return de.dhbw.rahmlab.casadi.impl.core__JNI.casadi_Function___hash__(swigCPtr, this);
  }
